(() => {
  ...
  function downloadAuditCsv() {
    ...
    DS.downloadTextFile?.(csv, `spicychat-creation-audit-${stamp}.csv`, "text/csv;charset=utf-8", { requestPermission: true });
  }
  ...
  function downloadAuditReport() {
    const report = buildAuditReport();
    const stamp = new Date().toISOString().slice(0, 10);
    DS.downloadTextFile?.(report, `spicychat-creation-audit-${stamp}.md`, "text/markdown;charset=utf-8", { requestPermission: true });
  }
